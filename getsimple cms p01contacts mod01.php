...
class P01contactForm
{
    ...
    public function post()
    {
        ...
        //echo "<h1>jon DEBUG 162: ";print_r($_POST['p01-contact_fields']);echo "_____END DEBUG</h1>";
        ...
        foreach ($fields as $field) {
            // echo "<h3>jon DEBUG 168:field: ";print_r($field,true);echo '$field["title"]'."___END DEBUG</h3>";
            ...
            //echo "<h1>jon DEBUG 174: posted_val=$posted_val posted[field->id]=".$posted[$field->id]." _".$field->title."____END DEBUG</h1>";
            $jon_csv=$jon_csv.$posted_val."|_|"; // jon 201204a
        }
        
        $form_name="jonToDoGetFormName"; // jon 201204a
        $this->jon_log($jon_csv,$form_name); // jon 201204a
