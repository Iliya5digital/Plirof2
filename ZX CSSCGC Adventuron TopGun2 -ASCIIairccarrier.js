...
//RC5b - aircarrier fix,bmb9,nuke aircarrier,throw rock
...
objects {
   ...
   king_kong          : scenery "King Kong.He seems angry or hungry. He guards the mountains. He likes throwing trees to airplanes!"  at = "loc_5_4" ;
   ...
   tom_cruise          : scenery "Tom Cruise who was the master mind behind this and also is the bad guy and end boss!"  at = "loc5_5boss" ;  
...
: print "MaveRick Dangerous !" ;
   ...
   : print "You will operate a highly automated drone manually. You can control it with the basic known commands! ";   
   : press_any_key ;
   : print "Mission briefing:";  
   ...
   : print "Good luck! Most of us here are counting on you! The other ones are in war room, designing \'Plan B\'.";     
   : press_any_key ;
}
...
on_describe {
   : if (is_at "loc_1_1base" && !is_exists "pln12" ) {
      ...
      : print "You can find the Update for -10D bathroom Design- in the Top Gun 2 48k tape!!!!" ;      
      : win_game ;
   }
   : if (is_present "old01") {
         : print "\n          --|--\n       *---o0o---*\n    --|-- \n*---o0o---* \n          --|--\n       *---o0o---*";
...
on_command {
   ...
   : match "launch missile;fire missile;drop bomb"  {
      : if (is_present "king_kong") {

         : print "You aim with your onboard super AI computer and fire. \nOne KK fart is enough to confuse the complex electronic sensors of your plane!!!";
         : print "You see on screen a message:\n R-Tape Loading Error!!!";
